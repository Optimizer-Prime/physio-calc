...
def mean_arterial_pressure(systolic: float, diastolic: float):
    """
...
def body_fat_male(height: float, neck: float, waist: float):
    ...
    """
    height = conversions.inches_to_millimeters(height)
    neck = conversions.inches_to_millimeters(neck)
    waist = conversions.inches_to_millimeters(waist)
...
def body_fat_female(height: float, neck: float, waist: float, hip: float):
    ...
    neck = conversions.inches_to_millimeters(neck)
    waist = conversions.inches_to_millimeters(waist)
    hip = conversions.inches_to_millimeters(hip)
